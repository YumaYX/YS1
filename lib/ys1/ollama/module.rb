  ...
  module Ollama
    ...
    module Module
      class << self
        ...
        # @param opts [YS1::Ollama::Options] options container
        # @return [Hash] request body payload for Ollama API
        #
        # @example Basic usage
        #   opts = YS1::Ollama::Options.new.add(:temperature, 0.7)
        #   request_body("Hello", opts)
        #
